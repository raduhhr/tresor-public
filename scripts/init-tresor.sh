...
#   ANSIBLE_PUBKEY="$(cat ~/.ssh/id_ed25519_example.pub)" SET_HOSTNAME="tresor-vm" sudo -E ./init-tresor.sh
...
echo "  ssh -i ~/.ssh/id_ed25519_example ${ANSIBLE_USER}@${ip_show:-<tresor-ip>}"
