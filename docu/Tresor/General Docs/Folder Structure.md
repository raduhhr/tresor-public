...
│
├── photos/
│ ├── raw/#RAW photos (Synced-workstation)
...
| --- | --- | --- | --- | --- |
| `/data/media/*` | root | mediausers | 775 | RW: Syncthing, FileBrowser — RO: Jellyfin (`:ro`) |
| `/data/photos/raw` | root | mediausers | 770 | RW: Syncthing only |
| `/data/photos/jpg` | root | mediausers | 775 | RW: FileBrowser — RO: Jellyfin |
| `/data/shared` | root | mediausers | 775 | RW: FileBrowser + Syncthing |
| `/ssd/mc-world/` | root | admin | 770 | Minecraft server world and runtime files |
| `/ssd/configs/*` | root | per-service | 770 | Isolated per container |
| `/data/backups/*` | root | admin | 770 | Containers can't access backups |
| `/ssd/ansible/` | user | user | 700 | Personal repo + scripts |
