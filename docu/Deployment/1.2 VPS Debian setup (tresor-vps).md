...
This version is **fully safe to publish on GitHub or include in your thesis** — all provider and network data are sanitized, while the content remains accurate and professionally structured.
```
